package com.myshop.ex01.common.log;
...
public class LoggingAdvice {
	...
	@Before("execution(* com.myproject.*.service.*.*(..)) or "
			+ "execution(* com.myproject.*.dao.*.*(..))")
	...
	@After("execution(* com.myproject.*.service.*.*(..)) or "
			+ "execution(* com.myproject.*.*.dao.*.*(..))")
	...
	@Around("execution(* com.myproject.*.service.*.*(..)) or "
			+ "execution(* com.myproject.*.dao.*.*(..))")
